                ...
                <table class="table table-hober">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!--<a href="Controlador?menu=Producto&accion=AgregarCarrito$codigoProducto=${producto.getCodigoProducto()}" class="btn btn-outline-info">Agregar Carrito</a>-->
                                <a class="btn btn-warning" href="Controlador?menu=Producto&accion=AgregarCarrito&codigoProducto=${producto.getCodigoProducto()}">Carrito</a>
                                <a class="btn btn-warning" href="Controlador?menu=Producto&accion=Editar&codigoProducto=${producto.getCodigoProducto()}">Editar</a>
                                <a class="btn btn-danger" onclick="return confirm('¿Quiere eliminar este registro?')" href="Controlador?menu=Producto&accion=Eliminar&codigoProducto=${producto.getCodigoProducto()}" >Eliminar</a>
                            </td>
                        </tr>
                        </c:forEach>
                    </tbody>
